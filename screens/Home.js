...
export default function Home() {
  ...
  const handleLogout = async () => {
    try {
      await logout(); // end Kinde session
    } catch (err) {
  ...
  return (
    <View style={styles.container}>
      ...
      <HomeHeader
        ...
        profileContent={
          <View
            style={{ position: 'relative', zIndex: 2000, elevation: 2000 }}
...
const styles = StyleSheet.create({
  ...
  menu: {
    ...
    backgroundColor: '#fff', borderRadius: 6, paddingVertical: 5,
    minWidth: 80, alignItems: 'center',
    elevation: 2000, shadowColor: '#000',
    shadowOpacity: 0.1, shadowOffset: { width: 0, height: 2 },
    shadowRadius: 4, zIndex: 2000,
  },
